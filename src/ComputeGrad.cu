...
//     // cuComplex h_grad[K];
//     // cudaMemcpy(h_grad, d_grad, K * sizeof(cuComplex),
//     cudaMemcpyDeviceToHost);
//     // for (int i = 0; i < K; i++)
//     // {
//     //     std::cout << "grad after data term[" << i << "] = (" <<
//     cuCreal(h_grad[i]) << "," << cuCimag(h_grad[i]) << ")\n";
//     // }
...
//                     K,
//                     &alpha_c, //
//                     注意这里使用1.0而不是alpha2，因为alpha2已经在gemv中使用了
//                     d_term2, 1,
//                     d_grad, 1);
...
//     // for (int i = 0; i < K; i++)
//     // {
//     //     std::cout << "final grad[" << i << "] = (" << cuCrealf(h_grad[i])
//     << "," << cuCimagf(h_grad[i]) << ")\n";
//     // }
